...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    // final userName = Provider.of<UserProvider>(context).name; // Kullanılmıyor, kaldırıldı
    // Tema renkleri
    const Color tropicalLime = Color(0xFFA3EBB1);
    const Color deepFern = Color(0xFF52796F);
    const Color midnightBlue = Color(0xFF2C3E50);
    // const Color whiteSmoke = Color(0xFFF5F5F5); // Kullanılmıyor, kaldırıldı
    // const Color oliveShadow = Color(0xFF6B705C); // Kullanılmıyor, kaldırıldı
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color:
                                    const Color(0xFFFFB86C).withValues(alpha: 0.08),
                              ),
                            ),
                          ),
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color:
                                    const Color(0xFF50FA7B).withValues(alpha: 0.08),
                              ),
                            ),
                          ),
                          // Noktalı desen
